...
namespace iCalendarDemo {
	public partial class CustomAppointmentEditForm : DevExpress.XtraEditors.XtraForm {
		...
		protected IAppointmentStorage Appointments { get { return control.Storage.Appointments; } }
		...
		private void btnOK_Click(object sender, System.EventArgs e) {
			...
			controller.SetLabel(edtLabel.AppointmentLabel);
		...
		void UpdateForm() {
			...
			try {
				...
				edtLabel.AppointmentLabel = Appointments.Labels.GetById(controller.LabelKey);
