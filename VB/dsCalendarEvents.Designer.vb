...
Namespace iCalendarDemo
    ...
    Partial Public Class CalendarEventsDataSet
        ...
        Public Shadows ReadOnly Property Events() As EventsDataTable
            Get
        ...
        Public Overrides Function Clone() As Global.System.Data.DataSet
            Dim cln As CalendarEventsDataSet = (DirectCast(MyBase.Clone(), CalendarEventsDataSet))
            cln.InitVars()
        ...
        Friend Sub InitVars(ByVal initTable As Boolean)
            Me.tableEvents = (DirectCast(MyBase.Tables("Events"), EventsDataTable))
        ...
        Partial Public Class EventsDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Function AddEventsRow(ByVal Subject As String, ByVal Start As Date, ByVal [End] As Date, ByVal Location As String, ByVal Body As String, ByVal MeetingStatus As Integer, ByVal ReminderData As String, ByVal RecipientsData As String) As EventsRow
            ...
            Public Function FindByUID(ByVal UID As Integer) As EventsRow
                Return (DirectCast(Me.Rows.Find(New Object() { UID}), EventsRow))
            End Function
        ...
        Partial Public Class EventsRow
            ...
            Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
                MyBase.New(rb)
                Me.tableEvents = (DirectCast(Me.Table, EventsDataTable))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
            Public Property UID() As Integer
                Get
                    Return (DirectCast(Me(Me.tableEvents.UIDColumn), Integer))
                End Get
            ...
            Public Property Start() As Date
                Get
                    Try
                        Return (DirectCast(Me(Me.tableEvents.StartColumn), Global.System.DateTime))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property [End]() As Date
                Get
                    Try
                        Return (DirectCast(Me(Me.tableEvents.EndColumn), Global.System.DateTime))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property Location() As String
                Get
                    Try
                        Return (DirectCast(Me(Me.tableEvents.LocationColumn), String))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property Body() As String
                Get
                    Try
                        Return (DirectCast(Me(Me.tableEvents.BodyColumn), String))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property MeetingStatus() As Integer
                Get
                    Try
                        Return (DirectCast(Me(Me.tableEvents.MeetingStatusColumn), Integer))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property ReminderData() As String
                Get
                    Try
                        Return (DirectCast(Me(Me.tableEvents.ReminderDataColumn), String))
                    Catch e As Global.System.InvalidCastException
            ...
            Public Property RecipientsData() As String
                Get
                    Try
                        Return (DirectCast(Me(Me.tableEvents.RecipientsDataColumn), String))
                    Catch e As Global.System.InvalidCastException
...
Namespace iCalendarDemo.CalendarEventsDataSetTableAdapters
    ...
    Partial Public Class EventsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE       Events" & ControlChars.CrLf & "SET                Subject = ?, Start = ?, [End] = ?, Locati" & "on = ?, Body = ?, MeetingStatus = ?, ReminderData = ?, RecipientsData = ?" & ControlChars.CrLf & "WHERE" & "        (UID = ?)"
        ...
        Public Overridable Function Delete(ByVal Original_UID As Integer, ByVal Original_Subject As String, ByVal Original_Start? As Global.System.DateTime, ByVal Original_End? As Global.System.DateTime, ByVal Original_Location As String, ByVal Original_MeetingStatus? As Integer) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = (CInt(Original_UID))
            ...
            If (Original_MeetingStatus.HasValue = True) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = (CInt((Original_MeetingStatus.Value)))
            Else
        ...
        Public Overridable Function Insert(ByVal Subject As String, ByVal Start? As Global.System.DateTime, ByVal [End]? As Global.System.DateTime, ByVal Location As String, ByVal Body As String, ByVal MeetingStatus? As Integer, ByVal ReminderData As String, ByVal RecipientsData As String) As Integer
            ...
            If (MeetingStatus.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(5).Value = (CInt((MeetingStatus.Value)))
            Else
        ...
        Public Overridable Function Update(ByVal Subject As String, ByVal Start? As Global.System.DateTime, ByVal [End]? As Global.System.DateTime, ByVal Location As String, ByVal Body As String, ByVal MeetingStatus? As Integer, ByVal ReminderData As String, ByVal RecipientsData As String, ByVal Original_UID As Integer) As Integer
            If (Subject Is Nothing) Then
            ...
            End If
            If (MeetingStatus.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(5).Value = (CInt((MeetingStatus.Value)))
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(8).Value = (CInt(Original_UID))
